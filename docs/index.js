...
"use strict";
var _Rx=__webpack_require__(39);var _shiftBlock=__webpack_require__(455);var _shiftBlock2=_interopRequireDefault(_shiftBlock);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}// Make screen type observable from events
// ready and resize
var load$=_Rx.Observable.fromEvent(window,'load');var resize$=_Rx.Observable.fromEvent(window,'resize');// Merge to common observable
var screen$=_Rx.Observable.merge(load$,resize$)// Normalize width value
.map(function(event){return!event.target.innerWidth?+window.innerWidth:+event.target.innerWidth;})// For example, if width more than 768px, type is desktop, else - mobile
.map(function(width){return width>800?{type:'desktop'}:{type:'mobile'};});// Init module
